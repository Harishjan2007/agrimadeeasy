-- ==============================================================================
-- AgriME Platform — Development Seed / Sample Data
-- IMPORTANT: Sample data for development and testing purposes only.
-- ==============================================================================
...
INSERT INTO crop_prices (id, crop_id, market_id, price, unit, recorded_at, source) VALUES
  ('33333333-3333-3333-3333-333333333301', '11111111-1111-1111-1111-111111111101', '22222222-2222-2222-2222-222222222201', 3450, '₹/Quintal', now() - INTERVAL '3 hours', 'Vellore Mandi Board'),
  ('33333333-3333-3333-3333-333333333302', '11111111-1111-1111-1111-111111111102', '22222222-2222-2222-2222-222222222201', 2380, '₹/Quintal', now() - INTERVAL '3 hours', 'Vellore Mandi Board'),
  ('33333333-3333-3333-3333-333333333303', '11111111-1111-1111-1111-111111111103', '22222222-2222-2222-2222-222222222202', 6850, '₹/Quintal', now() - INTERVAL '2 hours', 'Thiruvannamalai Regulated Market'),
  ('33333333-3333-3333-3333-333333333304', '11111111-1111-1111-1111-111111111104', '22222222-2222-2222-2222-222222222201', 2150, '₹/Quintal', now() - INTERVAL '4 hours', 'Vellore Mandi Board'),
  ('33333333-3333-3333-3333-333333333305', '11111111-1111-1111-1111-111111111105', '22222222-2222-2222-2222-222222222205', 7420, '₹/Quintal', now() - INTERVAL '1 hour', 'Guntur APMC Yard'),
  ('33333333-3333-3333-3333-333333333306', '11111111-1111-1111-1111-111111111106', '22222222-2222-2222-2222-222222222203', 1850, '₹/Quintal', now() - INTERVAL '5 hours', 'Kanchipuram Farmers Market'),
  ('33333333-3333-3333-3333-333333333307', '11111111-1111-1111-1111-111111111107', '22222222-2222-2222-2222-222222222204', 2450, '₹/Quintal', now() - INTERVAL '3 hours', 'Salem Agri Board'),
  ('33333333-3333-3333-3333-333333333308', '11111111-1111-1111-1111-111111111110', '22222222-2222-2222-2222-222222222201', 2200, '₹/Quintal', now() - INTERVAL '2 hours', 'Vellore Mandi Board')
ON CONFLICT (id) DO NOTHING;

-- 4. SEED CROP PREDICTIONS
...
-- 5. SEED VERIFIED GOVERNMENT SCHEMES (CENTRAL & TAMIL NADU)
INSERT INTO schemes (
  id,
  name,
  description,
...
-- 6. SEED DEMO DEALER PROFILES
INSERT INTO profiles (id, full_name, phone, role, district, state) VALUES
  ('66666666-6666-6666-6666-666666666601', 'K. Balaji (Demo Merchant)', '+91 98421 22334', 'dealer', 'Vellore', 'Tamil Nadu'),
  ('66666666-6666-6666-6666-666666666602', 'S. Shanmugam (Demo Mill Owner)', '+91 94432 55678', 'dealer', 'Vellore', 'Tamil Nadu'),
  ('66666666-6666-6666-6666-666666666603', 'M. Saravanan (Demo Dealer)', '+91 97890 11223', 'dealer', 'Ranipet', 'Tamil Nadu')
ON CONFLICT (id) DO NOTHING;

-- 7. SEED DEMO DEALERS
INSERT INTO dealers (id, profile_id, shop_name, address, phone, opening_hours) VALUES
  (
    '77777777-7777-7777-7777-777777777701',
    '66666666-6666-6666-6666-666666666601',
    'Sri Balaji Agro Traders (Demo Dealer)',
    'Mandi Gate 2, Katpadi Road, Vellore, Tamil Nadu 632004',
    '+91 98421 22334',
    '07:00 AM - 08:30 PM (Mon - Sat)'
  ),
  (
    '77777777-7777-7777-7777-777777777702',
    '66666666-6666-6666-6666-666666666602',
    'Annai Modern Rice Mill & Grain Buyer (Demo Dealer)',
    'Near Regulated Market, Thiruvannamalai Road, Vellore, Tamil Nadu 632001',
    '+91 94432 55678',
  ...
  (
    ...
    'GreenField Bio Inputs & Produce Buyers (Demo Dealer)',
    'Bypass Junction, Arcot Road, Ranipet, Tamil Nadu 632401',
    '+91 97890 11223',
    '08:30 AM - 09:00 PM (Mon - Sat)'
  )
ON CONFLICT (id) DO NOTHING;

-- 8. SEED DEMO DEALER CROP BUYING PRICES
INSERT INTO dealer_crop_prices (id, dealer_id, crop_id, buying_price, unit, active) VALUES
  -- Dealer 1 (Sri Balaji Agro Traders)
  ('88888888-8888-8888-8888-888888888801', '77777777-7777-7777-7777-777777777701', '11111111-1111-1111-1111-111111111102', 2400, '₹/Quintal', true),
  ('88888888-8888-8888-8888-888888888802', '77777777-7777-7777-7777-777777777701', '11111111-1111-1111-1111-111111111103', 6900, '₹/Quintal', true),
  ('88888888-8888-8888-8888-888888888803', '77777777-7777-7777-7777-777777777701', '11111111-1111-1111-1111-111111111104', 2180, '₹/Quintal', true),

  -- Dealer 2 (Annai Modern Rice Mill)
  ('88888888-8888-8888-8888-888888888804', '77777777-7777-7777-7777-777777777702', '11111111-1111-1111-1111-111111111101', 3500, '₹/Quintal', true),
  ('88888888-8888-8888-8888-888888888805', '77777777-7777-7777-7777-777777777702', '11111111-1111-1111-1111-111111111102', 2420, '₹/Quintal', true),

  -- Dealer 3 (GreenField Bio Inputs & Produce Buyers)
  ('88888888-8888-8888-8888-888888888806', '77777777-7777-7777-7777-777777777703', '11111111-1111-1111-1111-111111111103', 6950, '₹/Quintal', true),
  ('88888888-8888-8888-8888-888888888807', '77777777-7777-7777-7777-777777777703', '11111111-1111-1111-1111-111111111106', 1900, '₹/Quintal', true),
  ('88888888-8888-8888-8888-888888888808', '77777777-7777-7777-7777-777777777703', '11111111-1111-1111-1111-111111111105', 7450, '₹/Quintal', false)
ON CONFLICT (id) DO NOTHING;
