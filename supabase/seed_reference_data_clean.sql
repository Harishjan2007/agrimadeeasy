-- ==============================================================================
-- AgriME Platform — Safe Reference Data Seed (Clean & Validated)
-- Populates standalone reference data: Crops, Markets, Prices, Predictions, Schemes
-- Run this AFTER executing supabase/schema.sql.
-- All text fields containing apostrophes use PostgreSQL safe dollar quoting ($$...$$).
-- Safe for repeated executions via ON CONFLICT (id) DO UPDATE.
-- ==============================================================================

-- ==============================================================================
-- 1. SEED CROPS (10 Reference Crops)
-- ==============================================================================
...
-- ==============================================================================
-- 2. SEED MARKETS (6 Regulated APMC Mandis)
-- ==============================================================================
...
-- ==============================================================================
-- 3. SEED CROP PRICES (Reference Mandi Benchmarks — Not Live Stream)
-- ==============================================================================
...
-- ==============================================================================
-- 4. SEED CROP PREDICTIONS (Reference Price Forecast Models — Not Live AI)
-- ==============================================================================
...
-- ==============================================================================
-- 5. SEED GOVERNMENT SCHEMES (18 Programs: Central & Tamil Nadu)
-- ==============================================================================
INSERT INTO schemes (
  id,
  name,
