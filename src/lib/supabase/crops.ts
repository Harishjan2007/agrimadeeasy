 ...
 * Ordered by newest price records first (recorded_at DESC)
 */
export async function getCropPrices(): Promise<{
  ...
  try {
    ...
    if (error) {
      console.error('Supabase getCropPrices error:', error);
      return { data: [], error: new Error(error.message), isConfigured: true };
    }
    ...
    const error = err instanceof Error ? err : new Error('Failed to fetch crop prices');
    console.error('Unexpected error in getCropPrices:', error);
...
export async function getCropPredictions(): Promise<{
  ...
  try {
    ...
    if (error) {
      console.error('Supabase getCropPredictions error:', error);
      return { data: [], error: new Error(error.message), isConfigured: true };
    }
    ...
    const error = err instanceof Error ? err : new Error('Failed to fetch crop predictions');
    console.error('Unexpected error in getCropPredictions:', error);
    return { data: [], error, isConfigured: true };
  }
}
...
export async function getCrops(): Promise<{
  ...
  try {
    ...
    if (error) {
      console.error('Supabase getCrops error:', error);
    ...
    const error = err instanceof Error ? err : new Error('Failed to fetch crops');
    console.error('Unexpected error in getCrops:', error);
    return { data: [], error };
  }
}
...
export async function getMarkets(): Promise<{
  ...
  try {
    ...
    if (error) {
      console.error('Supabase getMarkets error:', error);
      return { data: [], error: new Error(error.message) };
    }
    ...
    console.error('Unexpected error in getMarkets:', error);
    return { data: [], error };
  }
}
