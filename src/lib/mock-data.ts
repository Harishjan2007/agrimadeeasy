...
export const MOCK_CROP_PRICES: CropPrice[] = [
  {
    ...
    source: 'Agmarknet APMC (Vellore Central Mandi)',
    source_status: 'RECENT',
    historical_prices: VERIFIED_HISTORICAL_PRICES['c1'],
    crop: MOCK_CROPS[0],
  ...
  },
  {
    ...
    source: 'Agmarknet APMC (Vellore Central Mandi)',
    source_status: 'RECENT',
    historical_prices: VERIFIED_HISTORICAL_PRICES['c2'],
    crop: MOCK_CROPS[1],
    market: MOCK_MARKETS[0]
  },
  {
    ...
    arrival_date: '2026-08-24',
    source: 'Agmarknet APMC (Thiruvannamalai Regulated Market)',
    source_status: 'RECENT',
    historical_prices: VERIFIED_HISTORICAL_PRICES['c3'],
    crop: MOCK_CROPS[2],
  ...
  },
  {
    ...
    source: 'Agmarknet APMC (Vellore Central Mandi)',
    source_status: 'RECENT',
    historical_prices: VERIFIED_HISTORICAL_PRICES['c4'],
    crop: MOCK_CROPS[3],
    market: MOCK_MARKETS[0]
  },
  {
    ...
    max_price: 7650,
    unit: '₹/Quintal',
    variety: 'MCU-5 Medium/Long Staple',
    recorded_at: '2026-08-24T08:00:00Z',
    arrival_date: '2026-08-24',
    source: 'Agmarknet APMC (Guntur Mirchi & Grain Yard)',
    source_status: 'RECENT',
    historical_prices: VERIFIED_HISTORICAL_PRICES['c5'],
    crop: MOCK_CROPS[4],
  ...
  },
  {
    ...
    arrival_date: '2026-08-24',
    source: 'Agmarknet APMC (Kanchipuram Farmers Market)',
    source_status: 'RECENT',
    historical_prices: VERIFIED_HISTORICAL_PRICES['c6'],
    crop: MOCK_CROPS[5],
  ...
  },
  {
    ...
    arrival_date: '2026-08-24',
    source: 'Agmarknet APMC (Salem Main Agri Market)',
    source_status: 'RECENT',
    historical_prices: VERIFIED_HISTORICAL_PRICES['c7'],
    crop: MOCK_CROPS[6],
  ...
  },
  {
    ...
    max_price: 2380,
    unit: '₹/Quintal',
    variety: 'Medium Red Nasik/Local',
    recorded_at: '2026-08-24T06:30:00Z',
    arrival_date: '2026-08-24',
    source: 'Agmarknet APMC (Vellore Central Mandi)',
    source_status: 'RECENT',
    historical_prices: VERIFIED_HISTORICAL_PRICES['c10'],
    crop: MOCK_CROPS[9],
    market: MOCK_MARKETS[0]
  },
  {
  ...
  },
  {
    ...
    arrival_date: '2026-08-24',
    source: 'Agmarknet APMC (Kanchipuram Agricultural Market)',
    source_status: 'RECENT',
    historical_prices: VERIFIED_HISTORICAL_PRICES['c2'],
    crop: MOCK_CROPS[1],
    market: MOCK_MARKETS[2]
